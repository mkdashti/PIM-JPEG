...
class SBProcess(_object):
    ...
    def SetDpuPrintInfo(self, open_print_sequence_addr, close_print_sequence_addr, print_buffer_addr, print_buffer_size, print_buffer_var_addr):
        """SetDpuPrintInfo(SBProcess self, uint32_t const open_print_sequence_addr, uint32_t const close_print_sequence_addr, uint32_t const print_buffer_addr, uint32_t const print_buffer_size, uint32_t const print_buffer_var_addr) -> SBError"""
        return _lldb.SBProcess_SetDpuPrintInfo(self, open_print_sequence_addr, close_print_sequence_addr, print_buffer_addr, print_buffer_size, print_buffer_var_addr)
...
class SBSymbol(_object):
    ...
    def GetIntegerValue(self):
        """GetIntegerValue(SBSymbol self) -> uint64_t"""
        return _lldb.SBSymbol_GetIntegerValue(self)
