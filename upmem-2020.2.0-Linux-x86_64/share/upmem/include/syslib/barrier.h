...
/**
 * @typedef barrier_id_t
 * @brief A barrier object reference, as returned by BARRIER_GET.
 */
typedef DEPRECATED barrier_t *barrier_id_t;

/**
 * @def BARRIER_GET
 * @hideinitializer
 * @brief Return the symbol to use when using the barrier associated to the given name.
 */
#define BARRIER_GET(_name) ((barrier_id_t)&_name)
