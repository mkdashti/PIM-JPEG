...
#define __builtin_lsr_rri(rc, ra, shift)                                                                                         \
    __asm__("lsr %[rc_wr32], %[ra_r32], " shift "" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_lsr_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("lsr %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsl_rri(rc, ra, shift)                                                                                         \
    __asm__("lsl %[rc_wr32], %[ra_r32], " shift "" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_lsl_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("lsl %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_addc_rri(rc, ra, imm)                                                                                          \
    __asm__("addc %[rc_wr32], %[ra_r32], " imm "" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_addc_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("addc %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsl_add_u_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("lsl_add.u %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_time_cfg_u_rr(dc, rb)                                                                                          \
    __asm__("time_cfg.u %[dc_wr64], %[rb_wr32]" : [ dc_wr64 ] "=r"(dc) : [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_call_rri(rc, ra, off)                                                                                          \
    __asm__("call %[rc_wr32], %[ra_r32], " off "" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_lsl1_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("lsl1 %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsr_add_u_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("lsr_add.u %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_or_rrrc(rc, ra, rb, log_set_cc)                                                                                \
    __asm__("or %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                               \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsrx_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("lsrx %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsl_add_rrri(rc, rb, ra, shift)                                                                                \
    __asm__("lsl_add %[rc_wr32], %[rb_wr32], %[ra_r32], " shift ""                                                               \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_lsr1x_zrr(zero, ra, rb)                                                                                        \
    __asm__("lsr1x %[zero], %[ra_r32], %[rb_wr32]" ::[ra_r32] "r"(ra), [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_cmpb4_zrr(zero, ra, rb)                                                                                        \
    __asm__("cmpb4 %[zero], %[ra_r32], %[rb_wr32]" ::[ra_r32] "r"(ra), [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_hash_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("hash %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsl1x_zrr(zero, ra, rb)                                                                                        \
    __asm__("lsl1x %[zero], %[ra_r32], %[rb_wr32]" ::[ra_r32] "r"(ra), [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_lsl_sub_s_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("lsl_sub.s %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_and_rri(rc, ra, imm)                                                                                           \
    __asm__("and %[rc_wr32], %[ra_wr32], " imm "" : [ rc_wr32 ] "=r"(rc) : [ ra_wr32 ] "r"(ra) :)
...
#define __builtin_and_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("and %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_rsub_rrrc(rc, ra, rb, sub_set_cc)                                                                              \
    __asm__("rsub %[rc_wr32], %[ra_r32], %[rb_wr32], " sub_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_rol_rri(rc, ra, shift)                                                                                         \
    __asm__("rol %[rc_wr32], %[ra_r32], " shift "" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_rol_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("rol %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_nand_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("nand %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_and_s_rki(dc, ra, imm)                                                                                         \
    __asm__("and.s %[dc_wr64], %[ra_r32], " imm "" : [ dc_wr64 ] "=r"(dc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_rol_add_s_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("rol_add.s %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_xor_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("xor %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lslx_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("lslx %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_nxor_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("nxor %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsl_sub_rrri(rc, rb, ra, shift)                                                                                \
    __asm__("lsl_sub %[rc_wr32], %[rb_wr32], %[ra_r32], " shift ""                                                               \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_ror_rri(rc, ra, shift)                                                                                         \
    __asm__("ror %[rc_wr32], %[ra_r32], " shift "" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_ror_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("ror %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsl_add_s_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("lsl_add.s %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_or_s_rri(dc, rb, imm)                                                                                          \
    __asm__("or.s %[dc_wr64], %[rb_wr32], " imm "" : [ dc_wr64 ] "=r"(dc) : [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_or_s_rrrc(dc, ra, rb, log_set_cc)                                                                              \
    __asm__("or.s %[dc_wr64], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_time_cfg_s_rr(dc, rb)                                                                                          \
    __asm__("time_cfg.s %[dc_wr64], %[rb_wr32]" : [ dc_wr64 ] "=r"(dc) : [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_rol_add_rrri(rc, rb, ra, shift)                                                                                \
    __asm__("rol_add %[rc_wr32], %[rb_wr32], %[ra_r32], " shift ""                                                               \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_and_u_rki(dc, ra, imm)                                                                                         \
    __asm__("and.u %[dc_wr64], %[ra_r32], " imm "" : [ dc_wr64 ] "=r"(dc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_orn_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("orn %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_rol_add_u_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("rol_add.u %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_lsr_add_rrri(rc, rb, ra, shift)                                                                                \
    __asm__("lsr_add %[rc_wr32], %[rb_wr32], %[ra_r32], " shift ""                                                               \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_asr_rri(rc, ra, shift)                                                                                         \
    __asm__("asr %[rc_wr32], %[ra_r32], " shift "" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_asr_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("asr %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsl_sub_u_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("lsl_sub.u %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
...
#define __builtin_lsr1_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("lsr1 %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_rsubc_zrr(zero, ra, rb)                                                                                        \
    __asm__("rsubc %[zero], %[ra_r32], %[rb_wr32]" ::[ra_r32] "r"(ra), [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_add_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("add %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_nor_rrrc(rc, ra, rb, log_set_cc)                                                                               \
    __asm__("nor %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                              \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_or_u_rri(dc, rb, imm)                                                                                          \
    __asm__("or.u %[dc_wr64], %[rb_wr32], " imm "" : [ dc_wr64 ] "=r"(dc) : [ rb_wr32 ] "r"(rb) :)
...
#define __builtin_or_u_rrrc(dc, ra, rb, log_set_cc)                                                                              \
    __asm__("or.u %[dc_wr64], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_subc_rir(rc, imm, ra)                                                                                          \
    __asm__("subc %[rc_wr32], " imm ", %[ra_r32]" : [ rc_wr32 ] "=r"(rc) : [ ra_r32 ] "r"(ra) :)
...
#define __builtin_andn_rrrc(rc, ra, rb, log_set_cc)                                                                              \
    __asm__("andn %[rc_wr32], %[ra_r32], %[rb_wr32], " log_set_cc ""                                                             \
            : [ rc_wr32 ] "=r"(rc)                                                                                               \
            : [ ra_r32 ] "r"(ra), [ rb_wr32 ] "r"(rb)                                                                            \
            :)
...
#define __builtin_lsr_add_s_rrri(dc, rb, ra, shift)                                                                              \
    __asm__("lsr_add.s %[dc_wr64], %[rb_wr32], %[ra_r32], " shift ""                                                             \
            : [ dc_wr64 ] "=r"(dc)                                                                                               \
            : [ rb_wr32 ] "r"(rb), [ ra_r32 ] "r"(ra)                                                                            \
            :)
