...
/**
 * @typedef sem_id_t
 * @brief A semaphore object reference, as returned by SEMAPHORE_GET.
 */
typedef DEPRECATED sem_t *sem_id_t;

/**
 * @def SEMAPHORE_GET
 * @hideinitializer
 * @brief Return the symbol to use when using the semaphore associated to the given name.
 */
#define SEMAPHORE_GET(_name) ((sem_id_t)&_name)
